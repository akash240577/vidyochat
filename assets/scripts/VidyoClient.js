    ...
    if (VCUtils.electronAvailable) {
        ...
        if (VCUtils.vcOnLoadComplete) {
            ...
            if (VCUtils.params.useNativeWebRTC == "true" || VCUtils.windowParams.useNativeWebRTC == "true") {
                ...
                $.when($.getScript(VCUtils.jsPath + "javascript/VidyoClient/WebRTC/VidyoClient.js"), $.Deferred(function (deferred) {
                    $(deferred.resolve);
                })).done(function () {
                    OnLoadSuccess_();
                }).fail(function () {
                ...
                $.when(
                /* Use of Native WebRTC has to be explicitly set for now */
                $.getScript(VCUtils.jsPath + "javascript/VidyoClient/VidyoClientDispatcher.js"), $.getScript(VCUtils.jsPath + "javascript/VidyoClient/VidyoClientTransportWebRTC.js"), $.Deferred(function (deferred) {
                    $(deferred.resolve);
                })).done(function () {
                    OnLoadSuccess_();
                }).fail(function () {
        ...
        if (VCUtils.vcOnLoadComplete) {
            ...
            $.when($.getScript(VCUtils.jsPath + "javascript/es6-promise/4.0.5/es6-promise.auto.min.js"), $.getScript(VCUtils.jsPath + "javascript/VidyoClient/VidyoClientDispatcher.js"), $.getScript(VCUtils.jsPath + "javascript/VidyoClient/VidyoClientTransportWeb.js"), $.Deferred(function (deferred) {
                $(deferred.resolve);
            })).done(function () {
                OnLoadSuccess_();
            }).fail(function () {
