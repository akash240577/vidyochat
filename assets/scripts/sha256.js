...
(function (I) {
    function w(c, a, d) {
        ...
        if (0 === c.lastIndexOf("SHA-", 0))
            if (q = function (b, a) { return A(b, a, c); }, y = function (b, a, l, f) {
                var g, e;
                ...
                if ("SHA-224" === c)
                    ...
                    throw Error("Unexpected error in SHA-2 implementation");
                return b;
            }, p = function (b) { return b.slice(); }, "SHA-224" === c)
                h = 512, e = 224;
            else if ("SHA-256" === c)
                h = 512, e = 256;
            else
        ...
        this.getHash = function (a, f) {
            ...
            switch (a) {
                case "HEX":
                    d = function (a) { return D(a, e, k); };
                    break;
                case "B64":
                    d = function (a) { return E(a, e, k); };
                    break;
                case "BYTES":
                    d = function (a) { return F(a, e); };
                    break;
                case "ARRAYBUFFER":
                    try {
                        h = new ArrayBuffer(0);
        ...
        this.getHMAC = function (a, f) {
            ...
            switch (a) {
                case "HEX":
                    d = function (a) { return D(a, e, t); };
                    break;
                case "B64":
                    d = function (a) { return E(a, e, t); };
                    break;
                case "BYTES":
                    d = function (a) { return F(a, e); };
                    break;
    ...
    function m() { }
    function D(c, a, d) { var l = ""; a /= 8; var b, g; for (b = 0; b < a; b += 1)
        g = c[b >>> 2] >>> 8 * (3 + b % 4 * -1), l += "0123456789abcdef".charAt(g >>> 4 & 15) + "0123456789abcdef".charAt(g & 15); return d.outputUpper ? l.toUpperCase() : l; }
    function E(c, a, d) {
        var l = "", b = a / 8, g, f, n;
        for (g = 0; g < b; g += 3)
    ...
    function F(c, a) { var d = "", l = a / 8, b, g; for (b = 0; b < l; b += 1)
        g = c[b >>> 2] >>> 8 * (3 + b % 4 * -1) & 255, d += String.fromCharCode(g); return d; }
    function G(c, a) { var d = a / 8, l, b = new ArrayBuffer(d), g; g = new Uint8Array(b); for (l = 0; l < d; l += 1)
        g[l] = c[l >>> 2] >>> 8 * (3 + l % 4 * -1) & 255; return b; }
    function C(c) {
    ...
    function B(c, a) {
        ...
        switch (c) {
            ...
            case "ARRAYBUFFER":
                ...
                d = function (a, b, c) { var d, n, k, e, h; b = b || [0]; c = c || 0; n = c >>> 3; h = new Uint8Array(a); for (d = 0; d < a.byteLength; d += 1)
                    e = d + n, k = e >>> 2, b.length <= k && b.push(0), b[k] |= h[d] << 8 * (3 + e % 4 * -1); return { value: b, binLen: 8 * a.byteLength + c }; };
                break;
    ...
    function P(c, a) { var d = (c & 65535) + (a & 65535); return ((c >>> 16) + (a >>> 16) + (d >>> 16) & 65535) << 16 | d & 65535; }
    function Q(c, a, d, l) {
        var b = (c & 65535) + (a & 65535) + (d & 65535) + (l & 65535);
        return ((c >>> 16) + (a >>> 16) + (d >>> 16) + (l >>> 16) + (b >>>
            16) & 65535) << 16 | b & 65535;
    }
    function R(c, a, d, l, b) { var g = (c & 65535) + (a & 65535) + (d & 65535) + (l & 65535) + (b & 65535); return ((c >>> 16) + (a >>> 16) + (d >>> 16) + (l >>> 16) + (b >>> 16) + (g >>> 16) & 65535) << 16 | g & 65535; }
    function x(c) {
        var a = [], d;
        if (0 === c.lastIndexOf("SHA-", 0))
    ...
    "function" === typeof define && define.amd ? define(function () { return w; }) : "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (module.exports = w), exports = w) : I.jsSHA = w;
})(this);
